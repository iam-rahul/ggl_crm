<%@ Page Title="" Language="C#" MasterPageFile="~/GeneralMaster.master" AutoEventWireup="true" CodeFile="CNGmaintenance.aspx.cs" Inherits="CNGmaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="cover">
        <div id="jox" class="Cbox">
            <div id="boxLeft">
                <marquee width="100%" direction="up"  onmouseover="stop()" onmouseout="start()" behavior="alternate" height="800px">
                    <ul style="list-style-type: none">
                        <li><a href="Demo3.aspx"><img src="images/LinksOrganization/300px-GAIL_Logo.svg_.png" style="width:200px; height:110px;"/></a></li>
            ...
            <div id="boxRight">
                    <h2 style="text-align:center;">CNG MAINTENANCE</h2>
                <img src="images/maps/PageUnderConstruction.jpg"  style="width:700px;  height:500px; margin-top:10px;" />
            </div>
        </div>
    </div>
</asp:Content>
