...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="register_heading"><h1>Register Here</h1></div>

    <table class="table-style1">
        <tr>
            <td>Name:</td>
            <td>
                <asp:TextBox ID="TxtName" CssClass="inputStyle" runat="server" placeholder="Please input your Name here..."></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DdlConType" runat="server" CssClass="inputStyle">
        ...
        <tr>
            <td>State: </td>
            <td>
                <asp:DropDownList ID="DdlState" CssClass="inputStyle" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DdlState_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>City:</td>
            <td>
                <asp:DropDownList ID="DdlCity" runat="server" CssClass="inputStyle">
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
        </tr>
