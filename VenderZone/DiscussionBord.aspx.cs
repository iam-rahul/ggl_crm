...
public partial class VenderZone_DiscussionBord : System.Web.UI.Page
{
    ...
    protected void BtnPost_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script>alert('There is some problem. Unable to save');</script>");
        }
    }
    ...
    protected void BtnAddAnswer_Click(object sender, EventArgs e)
    {
        if (TxtAnswer.Text != "")
        {
            ...
            if (dm.AddNewAnswer())
            {
                Response.Write("<script>alert('Your Answer posted successfully. <br> Thanx for Your Help');window.location.href='DiscussionBord.aspx'</script>");
            }
            else
            {
                Response.Write("<script>alert('There is Some Problem Unable to save answer')</script>");
            }
        }
        else
        {
            Response.Write("<script>alert('unable to save empty answer. Please write an Answer before Save')</script>");
